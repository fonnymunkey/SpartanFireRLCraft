...
public class JeiPlugin implements IModPlugin {
    ...
    public void register(IModRegistry registry) {
        if(ForgeConfigHandler.general.registerFlameIceThrowingRecipes) registry.addRecipes(FireIceLightningThrowingRecipeMaker.getFireIceLightningThrowingRecipes(), VanillaRecipeCategoryUid.CRAFTING);
